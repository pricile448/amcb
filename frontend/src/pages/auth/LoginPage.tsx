  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-6 sm:py-12 px-4 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        {successMessage && (
          <div className="mt-4 p-3 sm:p-4 bg-green-50 border border-green-200 rounded-lg mx-2">
            <div className="flex">
        ...
        <div className="bg-white py-6 sm:py-8 px-4 sm:px-6 lg:px-10 shadow sm:rounded-lg">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <button
                type="button"
                className="w-full inline-flex justify-center py-3 sm:py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-base sm:text-sm font-medium text-gray-500 hover:bg-gray-50 transition-colors duration-200"
              >
