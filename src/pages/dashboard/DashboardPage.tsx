          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-3 md:space-y-0">
            <div>
              ...
              <p className="text-sm md:text-lg font-mono">
                {userStatus !== 'verified' ? (userStatus === 'pending' ? 'RIB en cours de vérification' : 'RIB indisponible') : 'FR76 1234 5678 9012 3456 7890 123'}
              </p>
              <p className="text-blue-100 text-xs">
                {userStatus !== 'verified' ? (userStatus === 'pending' ? 'Vérification en cours - RIB disponible sous 24-48h' : 'Vérifiez votre identité pour accéder à votre RIB') : 'BIC: AMCBFRPPXXX'}
              </p>
            </div>
            <button 
            ...
            >
                              {userStatus !== 'verified' ? (userStatus === 'pending' ? 'RIB en cours de vérification' : 'RIB indisponible') : 'Copier'}
            </button>
          </div>
        </div>
      </div>
